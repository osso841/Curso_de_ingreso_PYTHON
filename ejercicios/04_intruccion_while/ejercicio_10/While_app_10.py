...
class App(customtkinter.CTk):
    ...
    def btn_comenzar_ingreso_on_click(self):
        ...
        while True:
            ...
            #escape por boton cancel prompt
            if numero == None:
                break
            #parseo de variable de ingreso
            numero = int(numero)
